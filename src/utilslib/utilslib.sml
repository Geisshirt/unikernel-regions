(* signature UTILS = sig
    ...
    val toHextets : int list -> int list 
    val toByteList : string -> int list
    val rawBytesString : int list -> string
    val byteListToString : int list -> string 
    val intToRawbyteString : int -> int -> string

    val getLBits : int -> int -> int 
    val getRBits : int -> int -> int 
    val setLBits : int -> int -> int 
 
    val makeChecksum : int list -> int
 
    val printCharsOfRawbytes : int list -> unit
    val convertRawBytes : string -> int
    val printRawBytes : string -> unit
end
