...
#define clearInfiniteBit(x) ((x) & (18446744073709551615UL ^ 0x1))

#define setAtbotBit(x)      ((x) | 0x2)
#define clearAtbotBit(x)    ((x) & (18446744073709551615UL ^ 0x2))

#define setStatusBits(x)    ((x) | 0x3)
#define clearStatusBits(x)  ((Region)(((uintptr_t)(x)) & (18446744073709551615UL ^ 0x3)))
